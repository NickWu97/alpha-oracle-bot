...
DEFAULT_CONFIG: dict = {
    ...
    # 🛡️ Hard filter（必要條件，任一不符直接拒絕）
    # 目標：12 幣種 × ~1 單/天 = 10–15 單/天
    "hard_filters": {
        "require_mtf_h4_align": True,    # 4H 趨勢必須順向（反向直接拒絕）
        "min_volume_ratio": 0.7,         # 最後 K 量必須 ≥ 0.7 倍均量
        "min_adx": 18,                   # 必須有最低趨勢強度（震盪市排除）
    },
